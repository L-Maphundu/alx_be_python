...
def what_to_wear(wthr: str) -> str:
    ...
    if wthr == 'sunny': print("Wear a t-shirt and sunglasses.")
    elif wthr == 'rainy': print("Don't forget your umbrella and a raincoat.")
    elif wthr == 'cold': print("Make sure to wear a warm coat and a scarf.")
